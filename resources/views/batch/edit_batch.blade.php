...
@section('body')
    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title">Edit Batch </h3>
                    ...
                    <div class="col-6">
                        <div class="form-floating mb-4">
                            <input type="text" class="form-control form-control-sm" id="example-text-input-floating"
                                name="batch_name" value="{{ $data->batch_name }}" placeholder="Enter Batch Name">
                    ...
                    <div class="col-6">
                        <div class="form-floating mb-4">
                            <select class="form-select" id="example-select-floating" name="current_batch"
                                ...
                                <option value="1"  {{ ($data->current_batch =='1' )?'selected':'' }}>Current / Active Batch</option>
                                <option value="0" {{ ($data->current_batch =='0' )?'selected':'' }}>Other </option>
                            </select>
                     ...
                     <div class="col-4">
                        <div class="form-floating mb-4">
                            <input type="submit" value="Update Batch" class="btn btn-outline-primary btn-sm  js-click-ripple-enabled" data-toggle="click-ripple">
                        </div>
                    </div>
                </div>
